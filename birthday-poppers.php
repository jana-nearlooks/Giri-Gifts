...
<head>
    ...
    <title>Giri Gifts - Birthday Poppers</title>
...
<body>
    ...
    <div class="page-wrapper overflow-x">
            ...
            <div class="container auto-container">
                <div class="row">
                    <div class="col-12 d-flex justify-content-lg-between justify-content-center align-items-center">
                        <ul class="media-box anouncement-list w-auto d-xl-flex d-none align-items-center justify-content-center d-none">
                        ...
                        <ul class="anouncement-list w-auto d-lg-flex d-none align-items-center justify-content-center">
                            ...
                            <li class="dropdown sellector ps-3 d-flex align-items-center hover-white lh-0">
                                <div>
                                    <button class="btn font-12 white font-josefin text-capitalize dropdown-toggle" type="button" id="dropdownMenu22" data-bs-toggle="dropdown" aria-expanded="false">
                                        MY ACCOUNT
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenu22">

                                        <li>
                                            <button class="dropdown-item text-center" type="button">User Login</button>
                                        </li>
                                        <li>
                                            <button class="dropdown-item text-center" type="button">Register</button>
                                        </li>
                                    </ul>
                                </div>
                            </li>
        ...
        <div class="page-content overflow-hidden">
            ...
            <section class="breadcrumb-area" style="background-image: url(assets/images/innerpage/bc-birthday-poppers.png);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-content pb-60 margintop--5 text-center wow fadeInUp animated">
                                <h2 class="fw-700">Birthday Poppers</h2>
                                <div class="breadcrumb-menu">
                                    <ul>
                                        <li><a href="index.php"><i class="flaticon-home pe-2"></i>Home</a></li>
                                        <li> <i class="flaticon-next"></i> </li>
                                        <li class="active">Birthday Poppers</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sliderParent globalarrow roundarrow mobileArrow position-relative">
                                ...
                                "pauseOnHover": false, "autoplaySpeed": 3000, "centerMode": false, "dots": false, "slidesToScroll": 1, "arrows": true,
                                    ...
                                    <div class="gridCategoryBox text-center">
                                        <a href="decoration-items.php" class="img-box">
                                            <div class="inner">
                                                <img src="assets/images/innerpage/pc-1.png" alt="">
                                            </div>
                                        </a>
                                        <div class="title">
                                            <a href="decoration-items.php" class="fw-600 font-josefin">
                                                <h6 class="fw-600 font-josefin">Decoration Items</h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="gridCategoryBox text-center">
                                        <a href="china-items.php" class="img-box">
                                            <div class="inner">
                                                <img src="assets/images/innerpage/pc-2.png" alt="">
                                            </div>
                                        </a>
                                        <div class="title">
                                            <a href="china-items.php" class="fw-600 font-josefin">
                                                <h6 class="fw-600 font-josefin">China Items</h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="gridCategoryBox text-center">
                                        <a href="birthday-poppers.php" class="img-box">
                                            <div class="inner">
                                                <img src="assets/images/innerpage/pc-3.png" alt="">
                                            </div>
                                        </a>
                                        <div class="title">
                                            <a href="birthday-poppers.php">
                                                <h6 class="fw-600 font-josefin">Birthday Poppers</h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="gridCategoryBox text-center">
                                        <a href="gift-items.php" class="img-box">
                                            <div class="inner">
                                                <img src="assets/images/innerpage/pc-4.png" alt="">
                                            </div>
                                        </a>
                                        <div class="title">
                                            <a href="gift-items.php">
                                                <h6 class="fw-600 font-josefin">Gift Items</h6>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 d-lg-flex d-none">
                            <div class="sidebar-content-box">
                                ...
                                <div class="sidebar-box mt-4 pt-2 wow fadeInUp animated">
                                    ...
                                    <form>
                                            <div class="form-group"> <i class="fa fa-dot-circle-o"></i> <a href="decoration-items.php" >Decoration Items</a> </div>
                                            <div class="form-group"> <i class="fa fa-dot-circle-o"></i> <a href="china-items.php">China Items</a> </div>
                                            <div class="form-group" style="color:#6A0067;"> <i class="fa fa-dot-circle-o"></i> <a href="birthday-poppers.php" style="color:#6A0067;">Birthday Poppers</a> </div>
                                            <div class="form-group"> <i class="fa fa-dot-circle-o"></i> <a href="gift-items.php">Gift Items</a> </div>
                        ...
                        <div class="col-xl-9 col-lg-8">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div
                                        ...
                                        <form action="#0" class="m-0 wow fadeInUp  animated" style="visibility: visible; animation-name: fadeInUp;">
                                    <div class="footer-input-box nborder p-0">
                                        <input class="ms-3 w-100" type="text" placeholder="search here ..." >
                            ...
                            <?php
                                include "db.php";
                                $product_query = "SELECT * FROM products, categories WHERE product_cat = cat_id AND cat_id = 3";
                                ...
                                if (mysqli_num_rows($run_query) > 0) {
                                    while ($row = mysqli_fetch_array($run_query)) {
                                        ...
                                        <div class='col-xl-3 col-md-4 col-sm-6 col-6 mt-30 wow fadeInUp  animated' style='visibility: visible; animation-name: fadeInUp;'>
                                        <div class='product-item'>
                                            <div class='product-image-wrapper'>
                                                <a class='d-block' href='product.php?p=$pro_id'>
                                                    <img src='product_images/$pro_image' alt='product'>
                                                </a>
                                                <span class='badge font-12 font-roboto radious2 bgBlack'>
                                                    New
                                                </span>
                                                <div class='btn-primary addBtn d-flex align-items-center justify-content-between text-uppercase font-14 fw-500'>
                                                    <a pid='$pro_id' id='product' href='#'>Add To Cart</a>
                                            
                                                </div>
                                            </div>
                                            <div class='product-content mt-2 pt-2 text-center position-relative'>
                                                <p class='font-roboto font-14 fw-400'>$cat_name</p>
                                                <a class='d-block pt-1' href='product.php?p=$pro_id'>
                                                    <h6 class='product-title font-josefin font-20 fw-600'>
                                                    $pro_title
                                                    </h6>
                                                </a>
                                                <div class='product-price pt-1 d-flex align-items-center justify-content-center'>
                                                    <span class='font-14 font-josefin me-2'>Rs.$pro_price</span>
                                ...
                                <div class="row align-items-center">
                                                ...
                                                <div class="qvBigImgBob">
                                                    <div id="tab7" class="tab-item qvImg">
                                                        <div class="popup-product-single-image">
                                                            <img src="assets/images/home-6/products-1.png" alt="img">
                                                        </div>
                                                    </div>
                                                    <div id="tab8" class="tab-item qvImg">
                                                        <div class="popup-product-single-image">
                                                            <img src="assets/images/home-6/products-2.png" alt="img">
                                                        </div>
                                                    </div>
                                                    <div id="tab9" class="tab-item qvImg">
                                                        <div class="popup-product-single-image">
                                                            <img src="assets/images/home-6/products-3.png" alt="img">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-details-content position-relative">
                                            ...
                                            <div class="product-price pdStyle1 mt-3 lh-1 d-flex align-items-center">
                                                <span class="regular-price font-josefin font-18 me-2"> $110.00 </span>
                                            ...
                                            <ul class="productSize font-roboto style2 mt-2">
                                                <li><a href="#0" class="font-josefin productSizeitem active me-2">S </a> </li>
                                                <li><a href="#0" class="font-josefin productSizeitem me-2">M</a></li>
                                                <li><a href="#0" class="font-josefin productSizeitem me-2">L</a></li>
                                                <li><a href="#0" class="font-josefin productSizeitem me-2">XL</a></li>
                                                <li><a href="#0" class="underline font-14">Size Guide</a></li>
                                            </ul>
                                            <p class="fw-500 font-josefin colorBlack mt-2 pt-2">
                                                Quantity
                                            </p>
                                            ...
                                            <ul class="d-flex align-items-center mt-2 pt-1">
                                                <li>
                                                    <a href="#0" class="d-inline-block me-2">
                                                        <img src="assets/images/innerpage/pay-1.jpg" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#0" class="d-inline-block me-2">
                                                        <img src="assets/images/innerpage/pay-2.jpg" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#0" class="d-inline-block me-2">
                                                        <img src="assets/images/innerpage/pay-3.jpg" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#0" class="d-inline-block me-2">
                                                        <img src="assets/images/innerpage/pay-4.jpg" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#0" class="d-inline-block me-2">
                                                        <img src="assets/images/innerpage/pay-5.jpg" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#0" class="d-inline-block">
                                                        <img src="assets/images/innerpage/pay-6.jpg" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <div class="offcanvas-body p-0">
                <nav>
                    <ul class="mobile-nav navbar-nav flex-column">
                        ...
                        <li class="dropdown-list nav-item p-0">
                            ...
                            <ul class="dropdown">
                                <li> <a class="dropdown-item" href="shop-grid-1.html">Decoration Items</a> </li>
                                <li> <a class="dropdown-item" href="shop-grid-2.html">China Items</a> </li>
                                <li> <a class="dropdown-item" href="shop-grid-3.html">Birthday Poppers</a> </li>
                                <li> <a class="dropdown-item" href="shop-list.html">Gift Items</a> </li>
                            </ul>
                        </li>
                        <li class="dropdown-list nav-item p-0">
                            <a href="#" class="nav-link">
                ...
                <ul class="mobile-contact-info">
                    <li class="single-minfo">
                        <a href="#0"><i class="flaticon-location-1"></i>Theni, Tamilnadu</a>
                    </li>
                    <li class="single-minfo">
                        <a href="#0"><i class="flaticon-account"></i>Log In / Sign Up</a>
                    </li>
                    <li class="single-minfo">
                        <a href="tel:+1234567890"><i class="flaticon-phone-call"></i>98421 06238</a>
                    </li>
                </ul>
                <p class="site-copyright">Copyright 2024 &copy; <a class="underline"
                        href="https://themeforest.net/user/mate_themes">Nearlook Mart Pvt</a>.
        ...
        <div class="offcanvas p-4 pt-3 pe-0 offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasRight">
