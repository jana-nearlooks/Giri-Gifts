...
<head>
    ...
    <title>Giri Gifts - Gift Items</title>
...
<body>
    ...
    <div class="page-wrapper overflow-x">
        ...
        <div class="page-content overflow-hidden">
            ...
            <section class="breadcrumb-area" style="background-image: url(assets/images/innerpage/bc-gift-items.png);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-content pb-60 margintop--5 text-center wow fadeInUp animated">
                                <h2 class="fw-700">Gift Items</h2>
                                <div class="breadcrumb-menu">
                                    <ul>
                                        <li><a href="index.php"><i class="flaticon-home pe-2"></i>Home</a></li>
                                        <li> <i class="flaticon-next"></i> </li>
                                        <li class="active">Gift Items</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="sidebar-box mt-4 pt-2 wow fadeInUp animated">
                                    ...
                                    <div class="checkbox-item font-roboto mt-2 pt-1">
                                        <form>
                                            ...
                                            <div class="form-group" style="color:#6A0067;"> <i class="fa fa-dot-circle-o"></i> <a href="gift-items.php" style="color:#6A0067;">Gift Items</a> </div>
