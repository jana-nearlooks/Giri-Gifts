...
<head>
    ...
    <title>Giri Gifts - Decoration Items</title>
...
<body>
    ...
    <div class="page-wrapper overflow-x">
        ...
        <div class="page-content overflow-hidden">
            ...
            <section class="breadcrumb-area" style="background-image: url(assets/images/innerpage/bc-decoration-items.png);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-content pb-60 margintop--5 text-center wow fadeInUp animated">
                                <h2 class="fw-700">Decoration Items</h2>
                                <div class="breadcrumb-menu">
                                    <ul>
                                        <li><a href="index.php"><i class="flaticon-home pe-2"></i>Home</a></li>
                                        <li> <i class="flaticon-next"></i> </li>
                                        <li class="active">Decoration Items</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 d-lg-flex d-none">
                            <div class="sidebar-content-box">
                                ...
                                <div class="sidebar-box mt-4 pt-2 wow fadeInUp animated">
                                    ...
                                    <form>
                                            <div class="form-group" style="color:#6A0067;"> <i class="fa fa-dot-circle-o"></i> <a href="decoration-items.php" style="color:#6A0067;">Decoration Items</a> </div>
                                            <div class="form-group"> <i class="fa fa-dot-circle-o"></i> <a href="china-items.php">China Items</a> </div>
                                            <div class="form-group"> <i class="fa fa-dot-circle-o"></i> <a href="birthday-poppers.php">Birthday Poppers</a> </div>
