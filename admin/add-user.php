      ...
      <div class="card">
            ...
            <div class="card-body">
              <form action="" method="post" name="form">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <label class="form-label" for="inputCity">Phone Number</label>
                  ...
                  <div class="form-group">
                      ...
                      <textarea type="text" name="country" id="country" class="form-control" rows="3" placeholder="Enter Address" required ></textarea>
                    </div>
                </div>
      
                <button type="submit" name="btn_save" id="btn_save" class="btn btn-primary">Add User</button>
              </form>
            </div>
          </div>
