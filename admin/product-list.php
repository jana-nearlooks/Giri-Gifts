          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">View all products</h2>
              </div>
            </div>
          </div>
        </div>
...
$result=mysqli_query($con,"select product_id,product_image, product_title, product_desc,  product_price from products  where  product_cat=1 or product_cat=2 or product_cat=3 or product_cat=4 or product_cat=5 or product_cat=6 or product_cat=7")or die ("query 1 incorrect.....");

while(list($product_id,$image,$product_name, $product_desc, $price)=mysqli_fetch_array($result))
{
echo "<tr><td><img src='../product_images/$image' style='width:70px; height:70px; border:groove #000'></td><td>$product_name</td> <td>$product_desc</td> 
<td>$price</td>
<td>
